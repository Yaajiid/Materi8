...
print_r($numbers); 
// Lakukan Looping di sini
// Melakukan looping untuk mencari sisa bagi dengan angka 5
$rest = [];
...
// Output: 
// Menggunakan looping foreach dengan tujuan untuk mengitarasi (perulangan sampai dapat hasilnya) melalui array $items
foreach ($items as $item) {
    ...
    echo "<pre>";
// Menampilkan array asosiatif dengan menggunakan fungsi print_r
    print_r($associativeArray);
// Membuat tampilan agar lebih mudah di pahami
    echo "</pre>";
}
...
* * * * * 
*/ 
// Menampilkan teks Asterix 
echo "Asterix: "; 
echo "<br>"; 

// Melakukan perulangan yang mana nilai nya dari 1 hingga 5
for ($i = 1; $i <= 5; $i++) {
    // Loop untuk kolom
    // Melakukan perulangan yang mana bertujuan untuk mengontrol jumlah kolom bintang yang akan di tampilkan
    for ($j = 1; $j <= $i; $j++) {
        echo "* ";
    }
    echo "<br>";
